...
static const uint8_t*    RxName[7];
static const uint8_t*    RxName_short[7];
static const uint8_t*    RxName_long[7];
...
//    _delay_ms(500);
	...
	// Declarations
	static const unsigned char*   opening_message0 = "Multi-Function Meter";
    static const unsigned char*   opening_message1 = " w/ FuelPump Driver ";
    static const unsigned char*   opening_message2 = "   Firmware Rev.6   ";
    ...
    static const int16_t eq_intercept[] = {
        -1,	// Turbo
        0,	// Tacho
        0,	// Oil pres.
        0,	// Fuel pres.
